...
print(NombresFrec)
NombresFrecAnyo = calcular_frecuencia_por_año(Nombres,'ABRIL')
print(NombresFrecAnyo)
mostrar_evolucion_por_año(Nombres,"IKER")
FrecuenciaAcumulada = calcular_frecuencia_acumulada(Nombres,"ABRIL")
print(FrecuenciaAcumulada)
FrecuenciasNombres = calcular_frecuencias_por_nombre(Nombres)
print(FrecuenciasNombres)